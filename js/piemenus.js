...
// Grid-based instrument selector modal dialog
const instrumentSelectorModal = (block, voiceLabels, voiceValues, categories, voice, rotate) => {
    ...
    const previewInstrument = (selectedVoice) => {
        ...
        setTimeout(() => {
            Singer.setSynthVolume(block.activity.logo, 0, selectedVoice, DEFAULTVOLUME);
...
const piemenuVoices = (block, voiceLabels, voiceValues, categories, voice, rotate) => {
    // Use the new grid-based instrument selector instead of radial wheel
    instrumentSelectorModal(block, voiceLabels, voiceValues, categories, voice, rotate);
};

// Legacy wheel-based implementation (keeping for reference/fallback)
const piemenuVoicesWheel = (block, voiceLabels, voiceValues, categories, voice, rotate) => {
